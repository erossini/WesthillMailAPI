...
using WesthillMail.SendCampaign.ApiServiceReference;

namespace WesthillMail.SendCampaign
{
    class Program
    {
        private const string UserName = "apiuser-e83513fc7ec7@apiconnector.com";
        private const string Password = "enrico!1975";
