...
Download the manual for Microsoft Windows from http://www.westhill.co.uk/api/apps/Westhill%20Mail%20API.exe
Download the manual for iOS from http://www.westhill.co.uk/api/apps/Westhill Mail API.app
